...
b25=new Button("CANCEL");
b26=new Button("CANCEL");
b27=new Button("CANCEL");
b28=new Button("CANCEL");
b29=new Button("DELETE ACCOUNT");
b30=new Button("CANCEL");
...
b25.setBounds(120,210,60,20);
b26.setBounds(120,210,60,20);
b27.setBounds(150,120,90,20);
b28.setBounds(160,240,80,20);
b29.setBounds(90,280,120,20);
b30.setBounds(90,320,120,20);
